...
class Connection:
    ...
    @overload
    async def read_response(self, *, timeout: float, disconnect_on_error: bool = ...) -> Incomplete | None:
        ...
    
    @overload
    async def read_response(self, disable_decoding: bool, timeout: float, *, disconnect_on_error: bool = ...) -> Incomplete | None:
        ...
    
    @overload
    async def read_response(self, disable_decoding: bool = ..., timeout: None = ..., *, disconnect_on_error: bool = ...):
        ...
...
class SSLConnection(Connection):
    ssl_context: Any
    def __init__(self, ssl_keyfile: str | None = ..., ssl_certfile: str | None = ..., ssl_cert_reqs: str = ..., ssl_ca_certs: str | None = ..., ssl_ca_data: str | None = ..., ssl_check_hostname: bool = ..., **kwargs) -> None:
        ...
...
class RedisSSLContext:
    ...
    check_hostname: Any
    context: Any
    def __init__(self, keyfile: str | None = ..., certfile: str | None = ..., cert_reqs: str | None = ..., ca_certs: str | None = ..., ca_data: str | None = ..., check_hostname: bool = ...) -> None:
        ...
...
class UnixDomainSocketConnection(Connection):
    ...
    redis_connect_func: ConnectCallbackT | None
    encoder: Any
    def __init__(self, *, path: str = ..., db: str | int = ..., username: str | None = ..., password: str | None = ..., socket_timeout: float | None = ..., socket_connect_timeout: float | None = ..., encoding: str = ..., encoding_errors: str = ..., decode_responses: bool = ..., retry_on_timeout: bool = ..., retry_on_error: list[type[RedisError]] | _Sentinel = ..., parser_class: type[BaseParser] = ..., socket_read_size: int = ..., health_check_interval: float = ..., client_name: str | None = ..., retry: Retry | None = ..., redis_connect_func: ConnectCallbackT | None = ..., credential_provider: CredentialProvider | None = ...) -> None:
        ...
...
class BlockingConnectionPool(ConnectionPool):
    queue_class: Any
    timeout: Any
    def __init__(self, max_connections: int = ..., timeout: int | None = ..., connection_class: type[Connection] = ..., queue_class: type[asyncio.Queue[Any]] = ..., **connection_kwargs) -> None:
        ...
