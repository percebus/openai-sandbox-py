...
_ConnectionPoolOptions: TypeAlias = ...
_ConnectFunc: TypeAlias = ...
class BaseParser:
...
class AbstractConnection:
    ...
    encoder: Encoder
    def __init__(self, db: int = ..., password: str | None = ..., socket_timeout: float | None = ..., socket_connect_timeout: float | None = ..., retry_on_timeout: bool = ..., retry_on_error: list[type[Exception]] = ..., encoding: str = ..., encoding_errors: str = ..., decode_responses: bool = ..., parser_class: type[BaseParser] = ..., socket_read_size: int = ..., health_check_interval: int = ..., client_name: str | None = ..., username: str | None = ..., retry: Retry | None = ..., redis_connect_func: _ConnectFunc | None = ..., credential_provider: CredentialProvider | None = ..., command_packer: Incomplete | None = ...) -> None:
        ...
    ...
    def read_response(self, disable_decoding: bool = ..., *, disconnect_on_error: bool = ...) -> Any:
        ...
...
class Connection(AbstractConnection):
    ...
    socket_type: int
    def __init__(self, host: str = ..., port: int = ..., socket_keepalive: bool = ..., socket_keepalive_options: Mapping[str, int | str] | None = ..., socket_type: int = ..., *, db: int = ..., password: str | None = ..., socket_timeout: float | None = ..., socket_connect_timeout: float | None = ..., retry_on_timeout: bool = ..., retry_on_error: list[type[Exception]] = ..., encoding: str = ..., encoding_errors: str = ..., decode_responses: bool = ..., parser_class: type[BaseParser] = ..., socket_read_size: int = ..., health_check_interval: int = ..., client_name: str | None = ..., username: str | None = ..., retry: Retry | None = ..., redis_connect_func: _ConnectFunc | None = ..., credential_provider: CredentialProvider | None = ..., command_packer: Incomplete | None = ...) -> None:
        ...
...
class SSLConnection(Connection):
    ...
    ssl_ocsp_context: Incomplete | None
    ssl_ocsp_expected_cert: Incomplete | None
    def __init__(self, ssl_keyfile=..., ssl_certfile=..., ssl_cert_reqs=..., ssl_ca_certs=..., ssl_ca_data: Incomplete | None = ..., ssl_check_hostname: bool = ..., ssl_ca_path: Incomplete | None = ..., ssl_password: Incomplete | None = ..., ssl_validate_ocsp: bool = ..., ssl_validate_ocsp_stapled: bool = ..., ssl_ocsp_context: Incomplete | None = ..., ssl_ocsp_expected_cert: Incomplete | None = ..., *, host: str = ..., port: int = ..., socket_timeout: float | None = ..., socket_connect_timeout: float | None = ..., socket_keepalive: bool = ..., socket_keepalive_options: Mapping[str, int | str] | None = ..., socket_type: int = ..., db: int = ..., password: str | None = ..., retry_on_timeout: bool = ..., retry_on_error: list[type[Exception]] = ..., encoding: str = ..., encoding_errors: str = ..., decode_responses: bool = ..., parser_class: type[BaseParser] = ..., socket_read_size: int = ..., health_check_interval: int = ..., client_name: str | None = ..., username: str | None = ..., retry: Retry | None = ..., redis_connect_func: _ConnectFunc | None = ..., credential_provider: CredentialProvider | None = ..., command_packer: Incomplete | None = ...) -> None:
        ...
...
class UnixDomainSocketConnection(AbstractConnection):
    path: str
    def __init__(self, path: str = ..., *, db: int = ..., password: str | None = ..., socket_timeout: float | None = ..., socket_connect_timeout: float | None = ..., retry_on_timeout: bool = ..., retry_on_error: list[type[Exception]] = ..., encoding: str = ..., encoding_errors: str = ..., decode_responses: bool = ..., parser_class: type[BaseParser] = ..., socket_read_size: int = ..., health_check_interval: int = ..., client_name: str | None = ..., username: str | None = ..., retry: Retry | None = ..., redis_connect_func: _ConnectFunc | None = ..., credential_provider: CredentialProvider | None = ..., command_packer: Incomplete | None = ...) -> None:
        ...
...
class ConnectionPool:
    ...
    def __init__(self, connection_class: type[AbstractConnection] = ..., max_connections: int | None = ..., **connection_kwargs) -> None:
        ...
...
class BlockingConnectionPool(ConnectionPool):
    ...
    timeout: float
    pool: Queue[Connection | None]
    def __init__(self, max_connections: int = ..., timeout: float = ..., connection_class: type[Connection] = ..., queue_class: type[Queue[Any]] = ..., **connection_kwargs) -> None:
        ...
