...
class ClusterDataAccessCommands(DataAccessCommands[_StrType]):
    def stralgo(self, algo, value1, value2, specific_argument: str = ..., len: bool = ..., idx: bool = ..., minmatchlen: Incomplete | None = ..., withmatchlen: bool = ..., **kwargs):
        ...
    


class RedisClusterCommands(ClusterMultiKeyCommands, ClusterManagementCommands, ACLCommands[_StrType], PubSubCommands, ClusterDataAccessCommands[_StrType]):
    ...
    def cluster_flushslots(self, target_nodes: Incomplete | None = ...) -> NoReturn:
        ...
    
    def cluster_bumpepoch(self, target_nodes: Incomplete | None = ...) -> NoReturn:
        ...
