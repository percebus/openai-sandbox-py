...
class ManagementCommands:
    ...
    def client_kill_filter(self, _id: Incomplete | None = ..., _type: Incomplete | None = ..., addr: Incomplete | None = ..., skipme: Incomplete | None = ..., laddr: Incomplete | None = ..., user: Incomplete | None = ..., **kwargs: _CommandOptions):
        ...
    ...
    def client_tracking_on(self, clientid: Incomplete | None = ..., prefix=..., bcast: bool = ..., optin: bool = ..., optout: bool = ..., noloop: bool = ...):
        ...
    
    def client_tracking_off(self, clientid: Incomplete | None = ..., prefix=..., bcast: bool = ..., optin: bool = ..., optout: bool = ..., noloop: bool = ...):
        ...
    
    def client_tracking(self, on: bool = ..., clientid: Incomplete | None = ..., prefix=..., bcast: bool = ..., optin: bool = ..., optout: bool = ..., noloop: bool = ..., **kwargs: _CommandOptions):
        ...
    ...
    def migrate(self, host, port, keys, destination_db, timeout, copy: bool = ..., replace: bool = ..., auth: Incomplete | None = ..., **kwargs: _CommandOptions):
        ...
    ...
    def shutdown(self, save: bool = ..., nosave: bool = ..., now: bool = ..., force: bool = ..., abort: bool = ..., **kwargs: _CommandOptions) -> None:
        ...
...
class AsyncManagementCommands:
    ...
    async def client_kill_filter(self, _id: Incomplete | None = ..., _type: Incomplete | None = ..., addr: Incomplete | None = ..., skipme: Incomplete | None = ..., laddr: Incomplete | None = ..., user: Incomplete | None = ..., **kwargs: _CommandOptions):
        ...
    
    async def client_info(self, **kwargs: _CommandOptions):
        ...
    
    async def client_list(self, _type: str | None = ..., client_id: list[str] = ..., **kwargs: _CommandOptions) -> list[dict[str, str]]:
        ...
    ...
    async def client_tracking_on(self, clientid: Incomplete | None = ..., prefix=..., bcast: bool = ..., optin: bool = ..., optout: bool = ..., noloop: bool = ...):
        ...
    
    async def client_tracking_off(self, clientid: Incomplete | None = ..., prefix=..., bcast: bool = ..., optin: bool = ..., optout: bool = ..., noloop: bool = ...):
        ...
    
    async def client_tracking(self, on: bool = ..., clientid: Incomplete | None = ..., prefix=..., bcast: bool = ..., optin: bool = ..., optout: bool = ..., noloop: bool = ..., **kwargs: _CommandOptions):
        ...
    ...
    async def migrate(self, host, port, keys, destination_db, timeout, copy: bool = ..., replace: bool = ..., auth: Incomplete | None = ..., **kwargs: _CommandOptions):
        ...
    ...
    async def shutdown(self, save: bool = ..., nosave: bool = ..., now: bool = ..., force: bool = ..., abort: bool = ..., **kwargs: _CommandOptions) -> None:
        ...
...
class BasicKeyCommands(Generic[_StrType]):
    ...
    __contains__ = ...
    def expire(self, name: _Key, time: int | timedelta, nx: bool = ..., xx: bool = ..., gt: bool = ..., lt: bool = ...) -> bool:
        ...
    ...
    def getex(self, name, ex: Incomplete | None = ..., px: Incomplete | None = ..., exat: Incomplete | None = ..., pxat: Incomplete | None = ..., persist: bool = ...):
        ...
    ...
    def lmove(self, first_list: _Key, second_list: _Key, src: Literal["LEFT", "RIGHT"] = ..., dest: Literal["LEFT", "RIGHT"] = ...) -> _Value:
        ...
    
    def blmove(self, first_list: _Key, second_list: _Key, timeout: float, src: Literal["LEFT", "RIGHT"] = ..., dest: Literal["LEFT", "RIGHT"] = ...) -> _Value | None:
        ...
    ...
    def pexpire(self, name: _Key, time: int | timedelta, nx: bool = ..., xx: bool = ..., gt: bool = ..., lt: bool = ...) -> Literal[1, 0]:
        ...
    
    def pexpireat(self, name: _Key, when: int | datetime, nx: bool = ..., xx: bool = ..., gt: bool = ..., lt: bool = ...) -> Literal[1, 0]:
        ...
    ...
    def restore(self, name, ttl, value, replace: bool = ..., absttl: bool = ..., idletime: Incomplete | None = ..., frequency: Incomplete | None = ...):
        ...
    
    def set(self, name: _Key, value: _Value, ex: None | float | timedelta = ..., px: None | float | timedelta = ..., nx: bool = ..., xx: bool = ..., keepttl: bool = ..., get: bool = ..., exat: Incomplete | None = ..., pxat: Incomplete | None = ...) -> bool | None:
        ...
    ...
    def stralgo(self, algo, value1, value2, specific_argument: str = ..., len: bool = ..., idx: bool = ..., minmatchlen: Incomplete | None = ..., withmatchlen: bool = ..., **kwargs: _CommandOptions):
        ...
...
class AsyncBasicKeyCommands(Generic[_StrType]):
    ...
    async def expire(self, name: _Key, time: int | timedelta, nx: bool = ..., xx: bool = ..., gt: bool = ..., lt: bool = ...) -> bool:
        ...
    ...
    async def getex(self, name, ex: Incomplete | None = ..., px: Incomplete | None = ..., exat: Incomplete | None = ..., pxat: Incomplete | None = ..., persist: bool = ...):
        ...
    ...
    async def lmove(self, first_list: _Key, second_list: _Key, src: Literal["LEFT", "RIGHT"] = ..., dest: Literal["LEFT", "RIGHT"] = ...) -> _Value:
        ...
    
    async def blmove(self, first_list: _Key, second_list: _Key, timeout: float, src: Literal["LEFT", "RIGHT"] = ..., dest: Literal["LEFT", "RIGHT"] = ...) -> _Value | None:
        ...
    ...
    async def pexpire(self, name: _Key, time: int | timedelta, nx: bool = ..., xx: bool = ..., gt: bool = ..., lt: bool = ...) -> Literal[1, 0]:
        ...
    
    async def pexpireat(self, name: _Key, when: int | datetime, nx: bool = ..., xx: bool = ..., gt: bool = ..., lt: bool = ...) -> Literal[1, 0]:
        ...
    ...
    async def restore(self, name, ttl, value, replace: bool = ..., absttl: bool = ..., idletime: Incomplete | None = ..., frequency: Incomplete | None = ...):
        ...
    
    async def set(self, name: _Key, value: _Value, ex: None | float | timedelta = ..., px: None | float | timedelta = ..., nx: bool = ..., xx: bool = ..., keepttl: bool = ..., get: bool = ..., exat: Incomplete | None = ..., pxat: Incomplete | None = ...) -> bool | None:
        ...
    ...
    async def stralgo(self, algo, value1, value2, specific_argument: str = ..., len: bool = ..., idx: bool = ..., minmatchlen: Incomplete | None = ..., withmatchlen: bool = ..., **kwargs: _CommandOptions):
        ...
...
class ListCommands(Generic[_StrType]):
    ...
    def lpos(self, name, value, rank: Incomplete | None = ..., count: Incomplete | None = ..., maxlen: Incomplete | None = ...):
        ...
...
class AsyncListCommands(Generic[_StrType]):
    ...
    async def linsert(self, name: _Key, where: Literal["BEFORE", "AFTER", "before", "after"], refvalue: _Value, value: _Value) -> int:
        ...
    ...
    async def lpos(self, name, value, rank: Incomplete | None = ..., count: Incomplete | None = ..., maxlen: Incomplete | None = ...):
        ...
    
    @overload
    async def sort(self, name: _Key, start: int | None = ..., num: int | None = ..., by: _Key | None = ..., get: _Key | Sequence[_Key] | None = ..., desc: bool = ..., alpha: bool = ..., store: None = ..., groups: bool = ...) -> list[_StrType]:
        ...
    
    @overload
    async def sort(self, name: _Key, start: int | None = ..., num: int | None = ..., by: _Key | None = ..., get: _Key | Sequence[_Key] | None = ..., desc: bool = ..., alpha: bool = ..., *, store: _Key, groups: bool = ...) -> int:
        ...
...
class ScanCommands(Generic[_StrType]):
    def scan(self, cursor: int = ..., match: _Key | None = ..., count: int | None = ..., _type: str | None = ..., **kwargs: _CommandOptions) -> tuple[int, list[_StrType]]:
        ...
    
    def scan_iter(self, match: _Key | None = ..., count: int | None = ..., _type: str | None = ..., **kwargs: _CommandOptions) -> Iterator[_StrType]:
        ...
    
    def sscan(self, name: _Key, cursor: int = ..., match: _Key | None = ..., count: int | None = ...) -> tuple[int, list[_StrType]]:
        ...
    
    def sscan_iter(self, name: _Key, match: _Key | None = ..., count: int | None = ...) -> Iterator[_StrType]:
        ...
    
    def hscan(self, name: _Key, cursor: int = ..., match: _Key | None = ..., count: int | None = ...) -> tuple[int, dict[_StrType, _StrType]]:
        ...
    
    def hscan_iter(self, name: _Key, match: _Key | None = ..., count: int | None = ...) -> Iterator[tuple[_StrType, _StrType]]:
        ...
    
    @overload
    def zscan(self, name: _Key, cursor: int = ..., match: _Key | None = ..., count: int | None = ...) -> tuple[int, list[tuple[_StrType, float]]]:
        ...
    
    @overload
    def zscan(self, name: _Key, cursor: int = ..., match: _Key | None = ..., count: int | None = ..., *, score_cast_func: Callable[[_StrType], _ScoreCastFuncReturn]) -> tuple[int, list[tuple[_StrType, _ScoreCastFuncReturn]]]:
        ...
    ...
    @overload
    def zscan_iter(self, name: _Key, match: _Key | None = ..., count: int | None = ..., *, score_cast_func: Callable[[_StrType], _ScoreCastFuncReturn]) -> Iterator[tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
...
class AsyncScanCommands(Generic[_StrType]):
    async def scan(self, cursor: int = ..., match: _Key | None = ..., count: int | None = ..., _type: str | None = ..., **kwargs: _CommandOptions) -> tuple[int, list[_StrType]]:
        ...
    
    def scan_iter(self, match: _Key | None = ..., count: int | None = ..., _type: str | None = ..., **kwargs: _CommandOptions) -> AsyncIterator[_StrType]:
        ...
    
    async def sscan(self, name: _Key, cursor: int = ..., match: _Key | None = ..., count: int | None = ...) -> tuple[int, list[_StrType]]:
        ...
    
    def sscan_iter(self, name: _Key, match: _Key | None = ..., count: int | None = ...) -> AsyncIterator[_StrType]:
        ...
    
    async def hscan(self, name: _Key, cursor: int = ..., match: _Key | None = ..., count: int | None = ...) -> tuple[int, dict[_StrType, _StrType]]:
        ...
    
    def hscan_iter(self, name: _Key, match: _Key | None = ..., count: int | None = ...) -> AsyncIterator[tuple[_StrType, _StrType]]:
        ...
    
    @overload
    async def zscan(self, name: _Key, cursor: int = ..., match: _Key | None = ..., count: int | None = ...) -> tuple[int, list[tuple[_StrType, float]]]:
        ...
    
    @overload
    async def zscan(self, name: _Key, cursor: int = ..., match: _Key | None = ..., count: int | None = ..., *, score_cast_func: Callable[[_StrType], _ScoreCastFuncReturn]) -> tuple[int, list[tuple[_StrType, _ScoreCastFuncReturn]]]:
        ...
    ...
    @overload
    def zscan_iter(self, name: _Key, match: _Key | None = ..., count: int | None = ...) -> AsyncIterator[tuple[_StrType, float]]:
        ...
    
    @overload
    def zscan_iter(self, name: _Key, match: _Key | None = ..., count: int | None = ..., *, score_cast_func: Callable[[_StrType], _ScoreCastFuncReturn]) -> AsyncIterator[tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
...
class StreamCommands:
    ...
    def xadd(self, name: KeyT, fields: Mapping[bytes | memoryview | str | float, bytes | memoryview | str | float], id: str | int | bytes | memoryview = ..., maxlen=..., approximate: bool = ..., nomkstream: bool = ..., minid: Incomplete | None = ..., limit: Incomplete | None = ...):
        ...
    
    def xautoclaim(self, name, groupname, consumername, min_idle_time, start_id: StreamIdT = ..., count: Incomplete | None = ..., justid: bool = ...):
        ...
    ...
    def xpending_range(self, name: _Key, groupname, min, max, count: int, consumername: Incomplete | None = ..., idle: int | None = ...):
        ...
    ...
    def xreadgroup(self, groupname, consumername, streams, count: Incomplete | None = ..., block: Incomplete | None = ..., noack: bool = ...):
        ...
    
    def xrevrange(self, name, max: str = ..., min: str = ..., count: Incomplete | None = ...):
        ...
    
    def xtrim(self, name, maxlen: int | None = ..., approximate: bool = ..., minid: Incomplete | None = ..., limit: int | None = ...):
        ...
...
class AsyncStreamCommands:
    ...
    async def xadd(self, name: KeyT, fields: Mapping[bytes | memoryview | str | float, bytes | memoryview | str | float], id: str | int | bytes | memoryview = ..., maxlen=..., approximate: bool = ..., nomkstream: bool = ..., minid: Incomplete | None = ..., limit: Incomplete | None = ...):
        ...
    
    async def xautoclaim(self, name, groupname, consumername, min_idle_time, start_id: StreamIdT = ..., count: Incomplete | None = ..., justid: bool = ...):
        ...
    
    async def xclaim(self, name, groupname, consumername, min_idle_time, message_ids, idle=..., time=..., retrycount=..., force=..., justid=...):
        ...
    ...
    async def xpending_range(self, name: _Key, groupname, min, max, count: int, consumername: Incomplete | None = ..., idle: int | None = ...):
        ...
    ...
    async def xreadgroup(self, groupname, consumername, streams, count: Incomplete | None = ..., block: Incomplete | None = ..., noack: bool = ...):
        ...
    
    async def xrevrange(self, name, max: str = ..., min: str = ..., count: Incomplete | None = ...):
        ...
    
    async def xtrim(self, name, maxlen: int | None = ..., approximate: bool = ..., minid: Incomplete | None = ..., limit: int | None = ...):
        ...
    


class SortedSetCommands(Generic[_StrType]):
    def zadd(self, name: _Key, mapping: Mapping[_Key, _Value], nx: bool = ..., xx: bool = ..., ch: bool = ..., incr: bool = ..., gt: Incomplete | None = ..., lt: Incomplete | None = ...) -> int:
        ...
    ...
    @overload
    def zrange(self, name: _Key, start: int, end: int, desc: bool, withscores: Literal[True], score_cast_func: Callable[[_StrType], _ScoreCastFuncReturn], byscore: bool = ..., bylex: bool = ..., offset: int | None = ..., num: int | None = ...) -> list[tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
    
    @overload
    def zrange(self, name: _Key, start: int, end: int, desc: bool, withscores: Literal[True], score_cast_func: Callable[[_StrType], float] = ..., byscore: bool = ..., bylex: bool = ..., offset: int | None = ..., num: int | None = ...) -> list[tuple[_StrType, float]]:
        ...
    
    @overload
    def zrange(self, name: _Key, start: int, end: int, *, withscores: Literal[True], score_cast_func: Callable[[_StrType], _ScoreCastFuncReturn], byscore: bool = ..., bylex: bool = ..., offset: int | None = ..., num: int | None = ...) -> list[tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
    
    @overload
    def zrange(self, name: _Key, start: int, end: int, *, withscores: Literal[True], score_cast_func: Callable[[_StrType], float] = ..., byscore: bool = ..., bylex: bool = ..., offset: int | None = ..., num: int | None = ...) -> list[tuple[_StrType, float]]:
        ...
    
    @overload
    def zrange(self, name: _Key, start: int, end: int, desc: bool = ..., withscores: bool = ..., score_cast_func: Callable[[_StrType], Any] = ..., byscore: bool = ..., bylex: bool = ..., offset: int | None = ..., num: int | None = ...) -> list[_StrType]:
        ...
    
    @overload
    def zrevrange(self, name: _Key, start: int, end: int, withscores: Literal[True], score_cast_func: Callable[[_StrType], _ScoreCastFuncReturn]) -> list[tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
    ...
    @overload
    def zrevrange(self, name: _Key, start: int, end: int, withscores: bool = ..., score_cast_func: Callable[[Any], Any] = ...) -> list[_StrType]:
        ...
    
    def zrangestore(self, dest, name, start, end, byscore: bool = ..., bylex: bool = ..., desc: bool = ..., offset: Incomplete | None = ..., num: Incomplete | None = ...):
        ...
    
    def zrangebylex(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ...) -> list[_StrType]:
        ...
    
    def zrevrangebylex(self, name: _Key, max: _Value, min: _Value, start: int | None = ..., num: int | None = ...) -> list[_StrType]:
        ...
    
    @overload
    def zrangebyscore(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ..., *, withscores: Literal[True], score_cast_func: Callable[[_StrType], _ScoreCastFuncReturn]) -> list[tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
    
    @overload
    def zrangebyscore(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ..., *, withscores: Literal[True]) -> list[tuple[_StrType, float]]:
        ...
    
    @overload
    def zrangebyscore(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ..., withscores: bool = ..., score_cast_func: Callable[[_StrType], Any] = ...) -> list[_StrType]:
        ...
    
    @overload
    def zrevrangebyscore(self, name: _Key, max: _Value, min: _Value, start: int | None = ..., num: int | None = ..., *, withscores: Literal[True], score_cast_func: Callable[[_StrType], _ScoreCastFuncReturn]) -> list[tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
    
    @overload
    def zrevrangebyscore(self, name: _Key, max: _Value, min: _Value, start: int | None = ..., num: int | None = ..., *, withscores: Literal[True]) -> list[tuple[_StrType, float]]:
        ...
    
    @overload
    def zrevrangebyscore(self, name: _Key, max: _Value, min: _Value, start: int | None = ..., num: int | None = ..., withscores: bool = ..., score_cast_func: Callable[[_StrType], Any] = ...) -> list[_StrType]:
        ...
    
    def zrank(self, name: _Key, value: _Value, withscore: bool = ...) -> int | None:
        ...
    ...
    def zrevrank(self, name: _Key, value: _Value, withscore: bool = ...) -> int | None:
        ...
...
class AsyncSortedSetCommands(Generic[_StrType]):
    async def zadd(self, name: _Key, mapping: Mapping[_Key, _Value], nx: bool = ..., xx: bool = ..., ch: bool = ..., incr: bool = ..., gt: Incomplete | None = ..., lt: Incomplete | None = ...) -> int:
        ...
    ...
    async def zinterstore(self, dest: _Key, keys: Iterable[_Key], aggregate: Literal["SUM", "MIN", "MAX"] | None = ...) -> int:
        ...
    ...
    @overload
    async def zrange(self, name: _Key, start: int, end: int, desc: bool, withscores: Literal[True], score_cast_func: Callable[[_StrType], _ScoreCastFuncReturn], byscore: bool = ..., bylex: bool = ..., offset: int | None = ..., num: int | None = ...) -> list[tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
    
    @overload
    async def zrange(self, name: _Key, start: int, end: int, desc: bool, withscores: Literal[True], score_cast_func: Callable[[_StrType], float] = ..., byscore: bool = ..., bylex: bool = ..., offset: int | None = ..., num: int | None = ...) -> list[tuple[_StrType, float]]:
        ...
    ...
    @overload
    async def zrange(self, name: _Key, start: int, end: int, desc: bool = ..., withscores: bool = ..., score_cast_func: Callable[[_StrType], Any] = ..., byscore: bool = ..., bylex: bool = ..., offset: int | None = ..., num: int | None = ...) -> list[_StrType]:
        ...
    
    @overload
    async def zrevrange(self, name: _Key, start: int, end: int, withscores: Literal[True], score_cast_func: Callable[[_StrType], _ScoreCastFuncReturn]) -> list[tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
    ...
    @overload
    async def zrevrange(self, name: _Key, start: int, end: int, withscores: bool = ..., score_cast_func: Callable[[Any], Any] = ...) -> list[_StrType]:
        ...
    
    async def zrangestore(self, dest, name, start, end, byscore: bool = ..., bylex: bool = ..., desc: bool = ..., offset: Incomplete | None = ..., num: Incomplete | None = ...):
        ...
    
    async def zrangebylex(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ...) -> list[_StrType]:
        ...
    
    async def zrevrangebylex(self, name: _Key, max: _Value, min: _Value, start: int | None = ..., num: int | None = ...) -> list[_StrType]:
        ...
    
    @overload
    async def zrangebyscore(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ..., *, withscores: Literal[True], score_cast_func: Callable[[_StrType], _ScoreCastFuncReturn]) -> list[tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
    
    @overload
    async def zrangebyscore(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ..., *, withscores: Literal[True]) -> list[tuple[_StrType, float]]:
        ...
    
    @overload
    async def zrangebyscore(self, name: _Key, min: _Value, max: _Value, start: int | None = ..., num: int | None = ..., withscores: bool = ..., score_cast_func: Callable[[_StrType], Any] = ...) -> list[_StrType]:
        ...
    
    @overload
    async def zrevrangebyscore(self, name: _Key, max: _Value, min: _Value, start: int | None = ..., num: int | None = ..., *, withscores: Literal[True], score_cast_func: Callable[[_StrType], _ScoreCastFuncReturn]) -> list[tuple[_StrType, _ScoreCastFuncReturn]]:
        ...
    
    @overload
    async def zrevrangebyscore(self, name: _Key, max: _Value, min: _Value, start: int | None = ..., num: int | None = ..., *, withscores: Literal[True]) -> list[tuple[_StrType, float]]:
        ...
    
    @overload
    async def zrevrangebyscore(self, name: _Key, max: _Value, min: _Value, start: int | None = ..., num: int | None = ..., withscores: bool = ..., score_cast_func: Callable[[_StrType], Any] = ...) -> list[_StrType]:
        ...
    
    async def zrank(self, name: _Key, value: _Value, withscore: bool = ...) -> int | None:
        ...
    ...
    async def zrevrank(self, name: _Key, value: _Value, withscore: bool = ...) -> int | None:
        ...
    ...
    async def zunionstore(self, dest: _Key, keys: Iterable[_Key], aggregate: Literal["SUM", "MIN", "MAX"] | None = ...) -> int:
        ...
...
class HashCommands(Generic[_StrType]):
    ...
    @overload
    def hset(self, name: _Key, key: _Key, value: _Value, mapping: Mapping[_Key, _Value] | None = ..., items: Incomplete | None = ...) -> int:
        ...
...
class AsyncHashCommands(Generic[_StrType]):
    ...
    @overload
    async def hset(self, name: _Key, key: _Key, value: _Value, mapping: Mapping[_Key, _Value] | None = ..., items: Incomplete | None = ...) -> int:
        ...
    
    @overload
    async def hset(self, name: _Key, key: None, value: None, mapping: Mapping[_Key, _Value], items: Incomplete | None = ...) -> int:
        ...
...
class AsyncScript:
    ...
    async def __call__(self, keys: Sequence[KeyT] | None = ..., args: Iterable[EncodableT] | None = ..., client: AsyncRedis[Any] | None = ...):
        ...
...
class GeoCommands:
    ...
    def georadius(self, name, longitude, latitude, radius, unit: Incomplete | None = ..., withdist: bool = ..., withcoord: bool = ..., withhash: bool = ..., count: Incomplete | None = ..., sort: Incomplete | None = ..., store: Incomplete | None = ..., store_dist: Incomplete | None = ..., any: bool = ...):
        ...
    
    def georadiusbymember(self, name, member, radius, unit: Incomplete | None = ..., withdist: bool = ..., withcoord: bool = ..., withhash: bool = ..., count: Incomplete | None = ..., sort: Incomplete | None = ..., store: Incomplete | None = ..., store_dist: Incomplete | None = ..., any: bool = ...):
        ...
    
    def geosearch(self, name, member: Incomplete | None = ..., longitude: Incomplete | None = ..., latitude: Incomplete | None = ..., unit: str = ..., radius: Incomplete | None = ..., width: Incomplete | None = ..., height: Incomplete | None = ..., sort: Incomplete | None = ..., count: Incomplete | None = ..., any: bool = ..., withcoord: bool = ..., withdist: bool = ..., withhash: bool = ...):
        ...
    
    def geosearchstore(self, dest, name, member: Incomplete | None = ..., longitude: Incomplete | None = ..., latitude: Incomplete | None = ..., unit: str = ..., radius: Incomplete | None = ..., width: Incomplete | None = ..., height: Incomplete | None = ..., sort: Incomplete | None = ..., count: Incomplete | None = ..., any: bool = ..., storedist: bool = ...):
        ...
...
class AsyncGeoCommands:
    ...
    async def georadius(self, name, longitude, latitude, radius, unit: Incomplete | None = ..., withdist: bool = ..., withcoord: bool = ..., withhash: bool = ..., count: Incomplete | None = ..., sort: Incomplete | None = ..., store: Incomplete | None = ..., store_dist: Incomplete | None = ..., any: bool = ...):
        ...
    
    async def georadiusbymember(self, name, member, radius, unit: Incomplete | None = ..., withdist: bool = ..., withcoord: bool = ..., withhash: bool = ..., count: Incomplete | None = ..., sort: Incomplete | None = ..., store: Incomplete | None = ..., store_dist: Incomplete | None = ..., any: bool = ...):
        ...
    
    async def geosearch(self, name, member: Incomplete | None = ..., longitude: Incomplete | None = ..., latitude: Incomplete | None = ..., unit: str = ..., radius: Incomplete | None = ..., width: Incomplete | None = ..., height: Incomplete | None = ..., sort: Incomplete | None = ..., count: Incomplete | None = ..., any: bool = ..., withcoord: bool = ..., withdist: bool = ..., withhash: bool = ...):
        ...
    
    async def geosearchstore(self, dest, name, member: Incomplete | None = ..., longitude: Incomplete | None = ..., latitude: Incomplete | None = ..., unit: str = ..., radius: Incomplete | None = ..., width: Incomplete | None = ..., height: Incomplete | None = ..., sort: Incomplete | None = ..., count: Incomplete | None = ..., any: bool = ..., storedist: bool = ...):
        ...
...
class DataAccessCommands(BasicKeyCommands[_StrType], HyperlogCommands, HashCommands[_StrType], GeoCommands, ListCommands[_StrType], ScanCommands[_StrType], SetCommands[_StrType], StreamCommands, SortedSetCommands[_StrType]):
    ...


class AsyncDataAccessCommands(AsyncBasicKeyCommands[_StrType], AsyncHyperlogCommands, AsyncHashCommands[_StrType], AsyncGeoCommands, AsyncListCommands[_StrType], AsyncScanCommands[_StrType], AsyncSetCommands[_StrType], AsyncStreamCommands, AsyncSortedSetCommands[_StrType]):
    ...


class CoreCommands(ACLCommands[_StrType], ClusterCommands, DataAccessCommands[_StrType], ManagementCommands, ModuleCommands, PubSubCommands, ScriptCommands[_StrType]):
    ...


class AsyncCoreCommands(AsyncACLCommands[_StrType], AsyncClusterCommands, AsyncDataAccessCommands[_StrType], AsyncManagementCommands, AsyncModuleCommands, AsyncPubSubCommands, AsyncScriptCommands[_StrType], AsyncFunctionCommands):
    ...
