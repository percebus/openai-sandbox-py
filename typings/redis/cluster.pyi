...
class RedisCluster(AbstractRedisCluster, RedisClusterCommands[_StrType]):
    ...
    def __init__(self, host: str | None = ..., port: int | None = ..., startup_nodes: list[ClusterNode] | None = ..., cluster_error_retry_attempts: int = ..., retry: Retry | None = ..., require_full_coverage: bool = ..., reinitialize_steps: int = ..., read_from_replicas: bool = ..., dynamic_startup_nodes: bool = ..., url: str | None = ..., address_remap: Callable[[str, int], tuple[str, int]] | None = ..., **kwargs) -> None:
        ...
    ...
    def get_node(self, host: str | None = ..., port: str | int | None = ..., node_name: str | None = ...) -> ClusterNode | None:
        ...
    ...
    def lock(self, name: str, timeout: float | None = ..., sleep: float = ..., blocking: bool = ..., blocking_timeout: float | None = ..., lock_class: type[Incomplete] | None = ..., thread_local: bool = ...):
        ...
...
class ClusterNode:
    ...
    def __init__(self, host: str, port: int, server_type: str | None = ..., redis_connection: Redis[Incomplete] | None = ...) -> None:
        ...
...
class NodesManager:
    ...
    connection_kwargs: dict[str, Incomplete]
    read_load_balancer: LoadBalancer
    address_remap: Callable[[str, int], tuple[str, int]] | None
    def __init__(self, startup_nodes: Iterable[ClusterNode], from_url: bool = ..., require_full_coverage: bool = ..., lock: Lock | None = ..., dynamic_startup_nodes: bool = ..., connection_pool_class: type[ConnectionPool] = ..., address_remap: Callable[[str, int], tuple[str, int]] | None = ..., **kwargs) -> None:
        ...
    
    def get_node(self, host: str | None = ..., port: int | str | None = ..., node_name: str | None = ...) -> ClusterNode | None:
        ...
...
class ClusterPubSub(PubSub):
    ...
    def __init__(self, redis_cluster: RedisCluster[Any], node: ClusterNode | None = ..., host: str | None = ..., port: int | None = ..., **kwargs) -> None:
        ...
    
    def set_pubsub_node(self, cluster: RedisCluster[Any], node: ClusterNode | None = ..., host: str | None = ..., port: int | None = ...) -> None:
        ...
...
class ClusterPipeline(RedisCluster[_StrType]):
    ...
    def __init__(self, nodes_manager, commands_parser, result_callbacks: Incomplete | None = ..., cluster_response_callbacks: Incomplete | None = ..., startup_nodes: Incomplete | None = ..., read_from_replicas: bool = ..., cluster_error_retry_attempts: int = ..., reinitialize_steps: int = ..., lock: Lock | None = ..., **kwargs) -> None:
        ...
